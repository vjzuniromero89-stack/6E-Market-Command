export const ENGINE_DEFINITIONS = Object.freeze({
  ...
  usd: { instruments:['EURUSD','GBPUSD','AUDUSD','NZDUSD','USDJPY','USDCHF','USDCAD','USDCNH'], description:'USD breadth normalized by volatility' },
  usdExEur: { instruments:['GBPUSD','AUDUSD','NZDUSD','USDJPY','USDCHF','USDCAD','USDCNH'], description:'USD breadth excluding EUR' },
