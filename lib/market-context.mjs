...
export const SYMBOLS = ['EUR/USD','GBP/USD','AUD/USD','NZD/USD','USD/JPY','USD/CHF','USD/CAD','EUR/GBP','EUR/JPY','EUR/CHF','EUR/CAD','EUR/AUD','EUR/NZD'];
...
if used + 13 > tonumber(ARGV[1]) then return -1 end
redis.call('SET', KEYS[1], '1', 'EX', 1200)
redis.call('INCRBY', budgetKey, 13)
